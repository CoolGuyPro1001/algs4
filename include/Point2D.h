...
struct Point2D
{
     ...
     */
    static bool xOrder(Point2D a, Point2D b);

    /**
     * Compares two points by y-coordinate.
     */
    static bool yOrder(Point2D a, Point2D b);

    /**
     * Compares two points by polar radius.
     */
    static bool rOrder(Point2D a, Point2D b);
     ...
     */
    bool polarOrder(Point2D a, Point2D b);
     ...
     * @return the comparator
     */
    bool atan2Order(Point2D a, Point2D b);
     ...
     * @return the comparator
     */
    bool distanceToOrder(Point2D a, Point2D b);
